      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.bodyContainer}>
          ...
          <Text style={styles.description}>
            This tool is intended for light-duty applications where it must drill tiny holes quickly.
            Drilling small holes requires a high speed and hand feed. Bolts and nuts are used to
            mount the machine's base on the floor or on a bench.
          </Text>
        </View>
      </View>
    </ScrollView>
